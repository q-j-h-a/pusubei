...
当前这台机器已经配置好 CosyVoice：

```text
CosyVoice 官方仓库：.cosyvoice/CosyVoice
Python 虚拟环境：.venv-cosyvoice
模型目录：.cosyvoice/CosyVoice/pretrained_models/CosyVoice-300M-SFT
服务地址：http://127.0.0.1:50000/inference_sft
日志文件：/tmp/cosyvoice_50000.log
PID 文件：/tmp/cosyvoice_50000.pid
```

启动服务：

```bash
./tools/start_cosyvoice.sh
```
